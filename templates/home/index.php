...
<head>
    ...
    <title>MiniCal - The better way to schedule your meetings</title>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-6 space-y-6">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 border border-slate-200/80 text-slate-700 text-xs font-semibold">
                    ...
                    <span data-i18n="hero_badge">Introducing MiniCal 1.0</span>
                </div>
                ...
                <p class="text-slate-600 text-base sm:text-lg leading-relaxed max-w-xl" data-i18n="hero_subheading">
                    MiniCal simplifies appointment scheduling. Share your custom booking link, sync calendars, collect payments, and automate form questions seamlessly.
                </p>
            ...
            <div class="space-y-4">
                <details class="bg-white border border-slate-200 rounded-2xl p-6 group cursor-pointer">
                    <summary class="font-bold text-slate-900 text-base flex justify-between items-center" data-i18n="faq_q1">
                        Is MiniCal completely free to use?
                    </summary>
                    <p class="text-slate-600 text-sm mt-4 leading-relaxed" data-i18n="faq_a1">
                        Yes! MiniCal MVP includes unlimited bookings, custom booking links, availability management, and custom form builders completely free.
                    </p>
                </details>
                ...
                <details class="bg-white border border-slate-200 rounded-2xl p-6 group cursor-pointer">
                    ...
                    <p class="text-slate-600 text-sm mt-4 leading-relaxed" data-i18n="faq_a2">
                        When connected, MiniCal reads your busy times from Google Calendar to prevent double booking, and creates events automatically upon new bookings.
                    </p>
                </details>
    ...
    <script>
        const i18n = {
            en: {
                ...
                hero_badge: "Introducing MiniCal 1.0",
                hero_heading: "The better way to schedule your meetings",
                hero_subheading: "MiniCal simplifies appointment scheduling. Share your custom booking link, sync calendars, collect payments, and automate form questions seamlessly.",
                ...
                faq_q1: "Is MiniCal completely free to use?",
                faq_a1: "Yes! MiniCal MVP includes unlimited bookings, custom booking links, availability management, and custom form builders completely free.",
                faq_q2: "How does Google Calendar synchronization work?",
                faq_a2: "When connected, MiniCal reads your busy times from Google Calendar to prevent double booking, and creates events automatically upon new bookings.",
            ...
            bn: {
                ...
                hero_badge: "নতুন মিনিকেল ১.০ সংস্করণ",
                hero_heading: "আপনার মিটিং সিডিউল করার সবচেয়ে সেরা মাধ্যম",
                hero_subheading: "মিনিকেল অ্যাপয়েন্টমেন্ট সিডিউলিংকে সহজ করে তোলে। আপনার কাস্টম বুকিং লিংক শেয়ার করুন, ক্যালেন্ডার সিঙ্ক করুন, পেমেন্ট গ্রহণ করুন এবং ফর্মের প্রশ্নগুলি স্বয়ংক্রিয় করুন।",
                ...
                faq_q1: "মিনিকেল কি সম্পূর্ণ বিনামূল্যে ব্যবহার করা যায়?",
                faq_a1: "হ্যাঁ! মিনিকেলে আনলিমিটেড বুকিং, কাস্টম বুকিং লিংক, এবং ফর্ম বিল্ডার সম্পূর্ণ ফ্রি।",
                faq_q2: "গুগল ক্যালেন্ডার সিঙ্ক্রোনাইজেশন কিভাবে কাজ করে?",
                faq_a2: "যুক্ত করার পর, মিনিকেল আপনার গুগল ক্যালেন্ডার থেকে ব্যস্ত সময়গুলো পড়ে ডাবল বুকিং প্রতিরোধ করে।",
        ...
        function setLanguage(lang) {
            ...
            localStorage.setItem('minical_lang', lang);
        ...
        const savedLang = localStorage.getItem('minical_lang') || 'en';
