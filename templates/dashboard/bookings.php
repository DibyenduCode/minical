...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="bg-white border border-slate-200/90 rounded-3xl p-6 space-y-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-xl font-extrabold text-slate-950 tracking-tight">Scheduled Appointments</h1>
                <p class="text-slate-500 text-xs font-medium mt-0.5">Manage and track your customer appointments, sessions, and forms.</p>
            </div>

            <!-- Filters & Search -->
            <form method="GET" action="<?= APP_URL ?>/bookings" class="flex flex-wrap items-center gap-3">
                            ...
                            <tr class="hover:bg-slate-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    $statusClasses = [
                                        ...
                                        'awaiting_payment' => 'bg-slate-100 text-slate-500 border-slate-200'
                                    ];
